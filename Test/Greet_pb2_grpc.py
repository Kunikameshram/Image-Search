...
class GreetingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                '/image_search.Greeting/SayHello',
...
def add_GreetingServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'image_search.Greeting', rpc_method_handlers)
...
class Greeting(object):
    ...
    def SayHello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/image_search.Greeting/SayHello',
